...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1278: (x0,x1,x2) => x0.setProperty(x1,x2),
      _1281: (x0,x1) => x0.append(x1),
      _1282: (x0,x1) => x0.querySelectorAll(x1),
      _1283: (x0,x1) => x0.item(x1),
      _1284: (x0,x1) => x0.getAttribute(x1),
      _1285: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1286: (x0,x1) => x0.replaceWith(x1),
      _1294: Date.now,
      ...
      _1441: (x0,x1,x2) => ({method: x0,headers: x1,body: x2}),
      _1442: (x0,x1,x2) => x0.fetch(x1,x2),
      _1443: x0 => x0.text(),
      _1456: (s, m) => {
        try {
      ...
      _1533: x0 => { globalThis.dartPaymentCompleted = x0 },
      _1534: x0 => { globalThis.dartPaymentFailed = x0 },
      _1535: x0 => { globalThis.dartPaymentError = x0 },
      _1536: x0 => { globalThis.dartWidgetReady = x0 },
      _1663: x0 => x0.style,
      _2900: (x0,x1) => { x0.src = x1 },
      _2902: (x0,x1) => { x0.type = x1 },
      _2911: x0 => x0.text,
      _2912: (x0,x1) => { x0.text = x1 },
      _3369: () => globalThis.window,
      _3412: x0 => x0.location,
      _3703: x0 => x0.href,
      _5985: x0 => x0.length,
      _6049: () => globalThis.document,
      _6405: (x0,x1) => { x0.innerHTML = x1 },
      _6487: (x0,x1) => { x0.innerHTML = x1 },
      _8516: x0 => x0.status,
